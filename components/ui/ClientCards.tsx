...
export const ClientCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20  max-w-[98dvw] overflow-hidden  [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]",
        className
      )}
    >
      <ul
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex items-center gap-1">
                  <div className="me-3 w-10 h-10">
                    <img src={item.clientProfile} alt={item.name} />
                  </div>
